...
{% include figure.html image="/assets/images/revealbot-seo-report.png" caption="First column is landing page URL, second column is the number of new signups" width="wide" %}
